...
@endif
    <div class="card">
  <h5 class="card-header">Products Listing <a href="{{ url('/') }}" class="btn btn-primary float-right">Home </a></h5>
  <div class="card-body">
            ...
            <div class="col-md-4"> <!-- Adjust the column width as needed -->
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('productsdetails', $product->id) }}" class="btn btn-info">Buy now</a>
                    </div>
                </div>
            </div>
        @endforeach
